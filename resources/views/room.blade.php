...
<div class="ui container large center aligned grid live_page">
    <div class="ui container grid center aligned">
        <!-- <div class="ui fourteen wide column room_message">
                asdasd
        </div> -->
        <div class="ui fourteen wide column room_message left aligned" style="margin-top:100px;margin-bottom:-50px;">
            <h2 class="ui header">
            ...
            <div class="ui raised very padded container left aligned">
              <!-- <p>The dogs' value to early human hunter-gatherers led to them quickly becoming ubiquitous across world cultures.</p> -->
            </div>
        </div>
    ...
    <div class="ui five wide column segment left aligned">
          <div class="reply_content" style="overflow:auto;">
