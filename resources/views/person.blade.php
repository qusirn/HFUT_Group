            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="pull-left">
                            <img src="/img/userphoto.png" alt="" class="thumb-md img-circle">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">马老师 <span class="caret"></span></a>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                <a href="index.html" class="waves-effect waves-light active"><i class="md md-home"></i><span> 我的资料 </span></a>
                            </li>

                            <li class="has_sub">
                                <a href="#" class="waves-effect waves-light"><i class="md md-mail"></i><span> 我的消息 </span><span class="pull-right"></span></a>
                            </li>

                            <li>
                                <a href="calendar.html" class="waves-effect"><i class="md md-event"></i><span> 直播安排 </span></a>
                            </li>
                            <li>
                                <a href="calendar.html" class="waves-effect"><i class="md md-tv"></i><span> 观看记录 </span></a>
                            </li>
                            <li>
                                <a href="calendar.html" class="waves-effect"><i class="md md-view-list"></i><span> 直播记录 </span></a>
                            </li>
                            <li>
                                <a href="calendar.html" class="waves-effect"><i class="md md-now-widgets"></i><span> 直播管理 </span></a>
                            </li>
                            <li>
                                <a href="calendar.html" class="waves-effect"><i class="md md-poll"></i><span> 我的等级 </span></a>
                            </li>
                            <li>
                                <a href="calendar.html" class="waves-effect"><i class="md md-grade"></i><span> 我的积分 </span></a>
                            </li>
                             <li>
                                <a href="calendar.html" class="waves-effect"><i class="md md-event"></i><span> 我的财富 </span></a>
                            </li>
                            <li>
